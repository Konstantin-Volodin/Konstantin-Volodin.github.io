...
const projectsData: Project[] = [
  {
    ...
    'longDescription': 'Participated in a hackathon with a team of other professionals centered around using the Databricks platform for a comprehensive sports analytics data product. Together we created a comprehensive data engineering product, processing data through Bronze to Gold layers. As part of the data analytics portion, we transformed gold stage data into actionable insights via an intuitive dashboard. Finally, for the data science portion, we tested and designed a predictive model, featuring data preparation, feature engineering, and model selection. This experience showcased our adaptability, collaborative prowess, and proficiency in cutting-edge tools for impactful solutions in sports analytics.',
  ...
  },
  {
    ...
    'longDescription': 'I developed a Google Cloud Platform (GCP) hosted website, seamlessly integrating a robust backend with an engaging frontend. This project, an extension for an existing organization, focuses on saving monkeys in Costa Rica. It features both external and internal components; externally, a user-friendly survey for accident reporting feeds vital data into the database, while internally, our team designed and implemented data manipulation tools, analytics and dashboarding components, and an optimization model for bridge locations. The tools employed include React for the frontend and GCP for secure, scalable backend infrastructure.',
  ...
  },
  {
    ...
    'longDescription': 'At OHRI, we needed a more efficient scheduling policy to address the backlog of elective surgeries caused by the Covid-19 pandemic. To tackle this challenge, I developed a linear optimization model accompanied by a demo user interface. Leveraging the capabilities of Python and React, the model successfully generated an optimized schedule that fulfilled all requirements. This project exemplifies the transformative impact of optimization techniques and web development skills in enhancing scheduling processes, particularly in times of heightened demand and constraints.',
