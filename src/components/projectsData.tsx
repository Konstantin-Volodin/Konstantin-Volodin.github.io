...
export default [
  {
    ...
    'description': 'Participated in a hackathon with a team of other professionals centered around using Databricks platform for a comprehensive sports analytics data product. Together we created comprehensive data engineering product, processing data throught Bronze to Gold layer. As part of data analytics portion, we transformed gold stage data into actionable insights via an intuitive dashboard. Finally for tge data science portion, we tested and designed a predictive model, featuring data preparation, feature engineering, and model selection. This experience showcased our adaptability, collaborative prowess, and proficiency in cutting-edge tools for impactful solutions in sports analytics.',
