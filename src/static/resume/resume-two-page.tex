...
% RESUME CONTENT
%====================
\input{variants/2-page/header} 

\begin{document}

\section{Skills}
\input{variants/2-page/skills}

\section{Experience}
\input{variants/2-page/experience}

\pagebreak
\section{Education}
\input{variants/2-page/education}

\section{Projects}
\input{variants/2-page/projects}

\section{About me}
\input{variants/2-page/about}
